...
public class CreateProjectRegionalDirectorTests extends BaseTest {


    /*Test 1 : Verify that user having regional director can advance project step from 'Early Conversations' to 'Completed'*/
    @Test
    public void verifyRegionalDirectorAndAdminCanTakeProjectToCompleted() throws InterruptedException {
        ...
        new ProjectFunctions(driver, selenium).createProjectAndGotoProjectDetailsPage(rdUser, data);
        ...
        Reporter.log("Step 5 - Logout Regional Director and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 6 - Find Project created by Regional Director and go to project detail page from project listing");
        ...
        Reporter.log("Step 8 - Logout admin user and Login again with Regional Director");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdUser.getEmail(), rdUser.getPassword());

        Reporter.log("Step 9 - Find Project created by Regional Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 11 - Logout Regional Director and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 12 - Find Project created by Regional Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 14 - Logout admin user and Login again with Regional Director");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdUser.getEmail(), rdUser.getPassword());

        Reporter.log("Step 15 - Find Project created by Regional Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 18 - Logout Regional Director and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 19 - Find Project created by Regional Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 21 - Logout admin user and Login again with Regional Director");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdUser.getEmail(), rdUser.getPassword());

        Reporter.log("Step 22 - Find Project created by Regional Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 26 - Logout Regional Director and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 27 - Find Project created by Regional Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        projectDetailsUpdateStepsPO.clickProjectOverrideStatusByName(ProjectStep.ActiveChangedPlan.getStep());

        Reporter.log("Step 29 - Logout admin user and Login again with Regional Director");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdUser.getEmail(), rdUser.getPassword());

        Reporter.log("Step 30 - Find Project created by Regional Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());

        Reporter.log("Step 31 - Advance Project step from 'Active Changed Plan' to 'Finalizing Completion'");
        ...
        Reporter.log("Step 32- Advance Project step from 'Finalizing Completion' to 'Completed'");
        ...
        Reporter.log("Step 33 - Verifying project step");
