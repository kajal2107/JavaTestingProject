...
public class CreateProjectRdProjectManagerTests extends BaseTest {


    /*Test 1 : Verify that user having regional director and project manager can advance project step from 'Early Conversations' to 'Completed'*/
    @Test
    public void verifyRegionalDirectorAndProjectManagerCanTakeProjectToCompleted() throws InterruptedException {
        ...
        new ProjectFunctions(driver, selenium).createProjectAndGotoProjectDetailsPage(rdFpmUser, data);
        ...
        Reporter.log("Step 5 - Logout Regional Director project manager and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 6 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        ...
        Reporter.log("Step 8 - Logout admin user and Login again with Regional Director Project Manager");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdFpmUser.getEmail(), rdFpmUser.getPassword());

        Reporter.log("Step 9 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 11 - Logout Regional Director Project Manager and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 12 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 14 - Logout admin user and Login again with Regional Director Project Manager");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdFpmUser.getEmail(), rdFpmUser.getPassword());

        Reporter.log("Step 15 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 18 - Logout Regional Director Project Manager and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 19 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 21 - Logout admin user and Login again with Regional Director Project Manager");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdFpmUser.getEmail(), rdFpmUser.getPassword());

        Reporter.log("Step 22 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());

        Reporter.log("Step 23 - Advance Project step from 'Active' to 'Discussing Change To Plan'");
        ...
        Reporter.log("Step 24 - Advance Project step from 'Discussing Change To Plan' to 'Pending Change To Plan Approval'");
        projectDetailsPO.clickOnProjectStepByName(ProjectStep.DiscussingChangeToPlan.getStep());
        projectDetailsUpdateStepsPO.advanceProjectByStepName(ProjectStep.SubmitforApproval.getStep());

        Reporter.log("Step 25 - Advance Project step from 'Pending Change To Plan Approval' to 'Active Changed Plan'");
        ...
        Reporter.log("Step 26 - Logout Regional Director Project Manager and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 27 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());

        Reporter.log("Step 28 - Advance Project step from 'Active Changed Plan' to 'Discussing Change To Plan'");//
        ...
        Reporter.log("Step 29 - Logout admin user and Login again with Regional Director Project Manager");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(rdFpmUser.getEmail(), rdFpmUser.getPassword());

        Reporter.log("Step 30 - Find Project created by Regional Director Project Manager and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());

        Reporter.log("Step 31 - Advance Project step from 'Pending Suspension Approval' to 'Approve Suspension'");
        ...
        Reporter.log("Step 32 - Advance Project step from 'Suspended' to 'Discussing ReActivation'");
        ...
        Reporter.log("Step 33 - Advance Project step from 'Active Changed Plan' to 'Finalizing Completion'");
        projectDetailsPO.clickOnProjectStepByName(ProjectStep.DiscussingReActivation.getStep());
        projectDetailsUpdateStepsPO.advanceProjectByStepName(ProjectStep.SubmitforApproval.getStep());

        Reporter.log("Step 34 - Advance Project step from 'Pending Reactivation Approval' to 'Approve Reactivation'");
        ...
        Reporter.log("Step 35 - Advance Project step from 'Active Changed Plan' to 'Finalize Completion'");
        ...
        Reporter.log("Step 36 - Advance Project step from 'Finalizing Completion' to 'Completed'");
        ...
        Reporter.log("Step 37 - Verifying project step");
