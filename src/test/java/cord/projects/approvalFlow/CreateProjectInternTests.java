...
public class CreateProjectInternTests extends BaseTest {


    /*Test 1 : Verify that user having intern can advance project step from 'Early Conversations' to 'Completed'*/
    @Test
    public void verifyInternCanTakeProjectToCompleted() throws InterruptedException {
        ...
        Reporter.log("Step 5 - Advance Project step from 'Pending Consultant Endorsement' to 'Prep For Financial Endorsement'");
        ...
        Reporter.log("Step 6 - Advance Project step from 'Prep For Financial Endorsement' to 'Pending Financial Endorsement'");
        ...
        Reporter.log("Step 7 - Advance Project step from 'Pending Financial Endorsement' to 'Finalizing Proposal'");
        ...
        Reporter.log("Step 8 - Advance Project step from 'Finalizing Proposal' to 'Pending Regional Director Approval'");
        ...
        Reporter.log("Step 9 - Advance Project step from 'Pending Regional Director Approval' to 'Pending Finance Confirmation'");
        ...
        Reporter.log("Step 10 - Advance Project step from 'Pending Finance Confirmation' to 'Active'");
        ...
        Reporter.log("Step 11 - Advance Project step from 'Active' to 'Finalize Completion'");
        ...
        Reporter.log("Step 12 - Advance Project step from 'Finalizing Completion' to 'Completed'");
        ...
        Reporter.log("Step 13 - Verifying project step");
