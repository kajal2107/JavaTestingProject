...
public class CreateProjectFieldOperationsDirectorTests extends BaseTest {


    /*Test 1 : Verify that user having field operations director can advance project step from 'Early Conversations' to 'Completed'*/
    @Test
    public void verifyFieldOperationsDirectorCanTakeProjectToCompleted() throws InterruptedException {
        ...
        new ProjectFunctions(driver, selenium).createProjectAndGotoProjectDetailsPage(fodUser, data);
        ...
        Reporter.log("Step 5 - Logout Field Operations Director and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 6 - Find Project created by Field Operations Director and go to project detail page from project listing");
        ...
        Reporter.log("Step 8 - Logout admin user and Login again with Field Operations Director");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(fodUser.getEmail(), fodUser.getPassword());

        Reporter.log("Step 9 - Find Project created by Field Operations Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 11 - Logout Field Operations Director and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 12 - Find Project created by Field Operations Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 14 - Logout admin user and Login again with Field Operations Director");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(fodUser.getEmail(), fodUser.getPassword());

        Reporter.log("Step 15 - Find Project created by Field Operations Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 18 - Logout Field Operations Director and Login with admin");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(adminUser.getEmail(), adminUser.getPassword());

        Reporter.log("Step 19 - Find Project created by Field Operations Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
        ...
        Reporter.log("Step 21 - Logout admin user and Login again with Field Operations Director");
        headerPO.signOut();
        login.fillLoginDetailsAndPerformLogin(fodUser.getEmail(), fodUser.getPassword());

        Reporter.log("Step 22- Find Project created by Field Operations Director and go to project detail page from project listing");
        sideHeader.clickOnProjectsMenu();
        headerPO.searchItemGloballyByName(data.getProjectName());
        projectsListingPO.clickOnProjectName(data.getProjectName());
