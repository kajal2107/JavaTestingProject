...
public class CreateGoalFilmTests extends BaseTest {

    /*Test 1 : Verify that user can create film goal full book successfully*/
    @Test
    public void verifyUserCanCreateFilmGoalWithFullBookSuccessfully() throws InterruptedException {
        ...
        Assert.assertEquals(projectLanguageEngagementDetailsPO.getGoalText(), (goalData.getGoalFilmName()), "goal type is not matched");
    ...
    /*Test 2 : Verify that user can create film Goal partial book known references from existing film with chapters successfully*/
    @Test
    public void verifyUserCanCreateFilmGoalPartialBookKnownReferencesFromExistingFilmWithChaptersSuccessfully() throws InterruptedException {
        ...
        createGoalPO.searchGoalNameAndAddGoal(GoalType.Film, searchGoalData);
        ...
        Assert.assertEquals(projectLanguageEngagementDetailsPO.getGoalText(), (searchGoalData.getGoalFilmName()), "Goal type is not matched");
    ...
    /*Test 3 : Verify that user can create film Goal partial book known references from existing film with different chapters successfully*/
    @Test
    public void verifyUserCanCreateFilmGoalPartialBookKnownReferencesFromExistingFilmWithDifferentChaptersSuccessfully() throws InterruptedException {
