...
public class MarketingTests extends BaseTest {
    ...
    protected String strMarketingPeopleUrl;
    protected String strMarketingLanguageUrl;
    protected String strMarketingProjectUrl;
    protected String strMarketingInternshipUrl;
    protected String strMarketingPartnershipUrl;
    protected String strMarketingFundingPartnershipUrl;
    protected String strMarketingProjectCreateGoalUrl;
    protected String strMarketingProjectTeamMemberUrl;
    protected String strMarketingLanguageTranslationUrl;
    People marketingPeopleFpmData = new PeopleData().getPeopleData();
    Project marketingAdminData = new ProjectData().getCreateProjectData();
    Project marketingAdminBudgetData = new ProjectData().getCreateProjectData();
    String marketingCreatedBudgetProjectName = marketingAdminBudgetData.getProjectName();
    Project marketingAdminTranslationData = new ProjectData().getCreateTranslationProjectData();
    Project marketingAdminTransEngagementData = new ProjectData().getCreateTranslationProjectData();
    String marketingCreatedTransEngagementProjectName = marketingAdminTransEngagementData.getProjectName();
    String marketingCreatedTranslationProjectName = marketingAdminTranslationData.getProjectName();
    String marketingCreatedProjectName = marketingAdminData.getProjectName();
    People marketingPeopleAdminData = new PeopleData().getPeopleData();
    People editMarketingPeopleAdminData = new PeopleData().getPeopleData();
    Project marketingEditProjectAdminData = new ProjectData().getUpdateProjectData();
    Language marketingLanguageAdminData = new LanguageData().getLanguageData();
    Partner marketingPartnerAdminData = new PartnerData().getCreatePartnerData();
    Partner marketingEditPartnerAdminData = new PartnerData().getEditPartnerData();
    Goal marketingGoalData = new GoalData().getCreateGoalData();
    Location marketingLocationData = new LocationData().getLocationData();
    String marketingLocationName = marketingLocationData.getLocationName();

    public MarketingTests() throws ParseException, java.text.ParseException, InterruptedException {
    }
    ...
    public void setupTestData() throws InterruptedException {
        ...
        new ProjectFunctions(driver, selenium).createProject(marketingAdminData);
        ...
        new ProjectFunctions(driver, selenium).createProject(marketingAdminBudgetData);
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 3 - Create TranslationType Project by admin user and logout that user");
        new ProjectFunctions(driver, selenium).createProject(marketingAdminTranslationData);
        new PartnershipFunctions(driver, selenium).createProjectPartnership(marketingPartnerAdminData ,marketingCreatedTranslationProjectName,adminUser);
        ...
        new ProjectFunctions(driver, selenium).createProject(marketingAdminTransEngagementData);
        strMarketingProjectUrl = driver.getCurrentUrl();
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 5 - Create People by admin user");
        new PeopleFunctions(driver, selenium).createPeople(marketingPeopleAdminData,adminUser);
        new LoginFunctions(driver, selenium).signOutAndChangeUser(fpmUser);

        Reporter.log("Step 6 - Create People by project manager user");
        new PeopleFunctions(driver, selenium).createPeople(marketingPeopleFpmData,fpmUser);
        strMarketingPeopleUrl = driver.getCurrentUrl();
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 7 - Create Language by admin user");
        new LanguageFunctions(driver, selenium).createLanguage(marketingLanguageAdminData);
        strMarketingLanguageUrl = driver.getCurrentUrl();
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 8 - Create internship engagements by admin user");
        new InternshipEngagementsFunctions(driver, selenium).createProjectInternshipEngagements(adminUser, marketingCreatedProjectName);
        strMarketingInternshipUrl = driver.getCurrentUrl();
        selenium.hardWait(3);
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 9 - Create language engagements by admin user");
        new LanguageFunctions(driver, selenium).createProjectLanguageEngagements(marketingLanguageAdminData, marketingCreatedTranslationProjectName,adminUser);
        strMarketingLanguageTranslationUrl = driver.getCurrentUrl();
        selenium.hardWait(3);
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 10 - Create Partner by admin user");
        new PartnerFunctions(driver, selenium).createPartner(marketingPartnerAdminData);
        selenium.hardWait(3);
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 11 - Create partnership by admin user");
        new PartnershipFunctions(driver, selenium).createProjectPartnership(marketingPartnerAdminData, marketingCreatedTranslationProjectName,adminUser);
        strMarketingPartnershipUrl = driver.getCurrentUrl();
        selenium.hardWait(3);
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 12 - Add project team member with multiple user role");
        new ProjectFunctions(driver, selenium).addMemberToProject(rdFodUser, marketingAdminData);
        strMarketingProjectTeamMemberUrl = driver.getCurrentUrl();
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 13 - Create Location by admin user");
        new LocationFunctions(driver, selenium).createLocation(marketingLocationData);
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 14 - Create goal by admin user");
        selenium.navigateToPage(strMarketingLanguageTranslationUrl);
        new GoalFunctions(driver, selenium).createGoal(marketingGoalData, marketingLanguageAdminData.getLanguageEngagementName(),marketingPartnerAdminData.getOrganizationName());
        strMarketingProjectCreateGoalUrl = driver.getCurrentUrl();
        new LoginFunctions(driver, selenium).signOutAndChangeUser(adminUser);

        Reporter.log("Step 15 - Create funding partnership by admin user");
        new ProjectFunctions(driver, selenium).editInternshipProjectByName(marketingEditProjectAdminData, marketingCreatedBudgetProjectName,adminUser);
        new PartnershipFunctions(driver, selenium).createProjectFundingPartnership(marketingPartnerAdminData, marketingEditProjectAdminData.getProjectName());
        strMarketingFundingPartnershipUrl = driver.getCurrentUrl();
        drivermanager.tearDown();
    }

    /*Test 1 : Verify that marketing can view all projects*/
    @Test(priority = 1)
    public void VerifyMarketingCanViewAllProjectsSuccessfully() throws InterruptedException {
        ...
        Reporter.log("Step 1 - Navigate to url and login with marketing user");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        ...
        if (!projectsListingPO.isProjectPresent(marketingAdminData.getProjectName())) {
            headerPO.searchItemGloballyByName(marketingAdminData.getProjectName());
        }
        projectsListingPO.clickOnProjectName(marketingAdminData.getProjectName());
        Assert.assertEquals(projectDetailsPO.getProjectName(), marketingAdminData.getProjectName(), "Project is not present : " + marketingAdminData.getProjectName());

        Reporter.log("Step 3 - Verify that projects is displayed which is created by FPM user");
        sideHeader.clickOnProjectsMenu();
        projectsListingPO.clickOnProjectSubTabs(ProjectSubTabs.All.getProjectSubTabs());

        if (!projectsListingPO.isProjectPresent(marketingAdminTransEngagementData.getProjectName())) {
            headerPO.searchItemGloballyByName(marketingAdminTransEngagementData.getProjectName());
        }
        projectsListingPO.clickOnProjectName(marketingAdminTransEngagementData.getProjectName());
        Assert.assertEquals(projectDetailsPO.getProjectName(), marketingAdminTransEngagementData.getProjectName(), "Project is not present : " + marketingAdminTransEngagementData.getProjectName());

    }

    /*Test 2 : Verify that marketing can view all peoples*/
    @Test(priority = 2)
    public void VerifyMarketingCanViewAllPeoplesSuccessfully() throws InterruptedException {
        ...
        Reporter.log("Step 1 - Navigate to url and login with marketing user");
        selenium.navigateToPage(strMarketingPeopleUrl);
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);

        Reporter.log("Step 2 - Verify that peoples is displayed which is created by admin");
        sideHeader.clickOnPeopleMenu();
        if (!peoples.isPeoplePresent(marketingPeopleAdminData.getPersonName())) {
            headerPO.searchItemGloballyByName(marketingPeopleAdminData.getPersonName());
        }
        peoples.clickOnPeopleName(marketingPeopleAdminData.getPersonName());
        Assert.assertEquals(peopleDetails.getPeopleName().replaceAll("\\s.*", ""), marketingPeopleAdminData.getPersonName(), "People is not present : " + marketingPeopleAdminData.getPersonName());

        Reporter.log("Step 3 - Verify that peoples is displayed which is created by FPM user");
        sideHeader.clickOnPeopleMenu();
        if (!peoples.isPeoplePresent(marketingPeopleFpmData.getPersonName())) {
            headerPO.searchItemGloballyByName(marketingPeopleFpmData.getPersonName());
        }
        peoples.clickOnPeopleName(marketingPeopleFpmData.getPersonName());
        Assert.assertEquals(peopleDetails.getPeopleName().replaceAll("\\s.*", ""), marketingPeopleFpmData.getPersonName(), "People is not present : " + marketingPeopleFpmData.getPersonName());

    }

    /*Test 3 : Verify that marketing can edit mine peoples */
    @Test(priority = 3)
    public void VerifyThatMarketingCanEditMinePeoples() throws InterruptedException {
        ...
        Reporter.log("Step 2 - Search user which have a marketing role by email and click on people name");
        sideHeader.clickOnPeopleMenu();
        if (!peoples.isPeoplePresent(mrktUser.getEmail())) {
            headerPO.searchItemGloballyByName(mrktUser.getEmail());
        }
        peoples.clickOnPeopleName(mrktUser.getRealFirstName() + " " + mrktUser.getRealLastName());

        Reporter.log("Step 3 - Click on edit icon and edit mine person detail");
        peopleDetails.clickOnEditButton();
        updatePeople.clearAndUpdatePersonDetail(marketingPeopleAdminData);
        updatePeople.clickOnSubmitButton();

        Reporter.log("Step 4 - Verify updated person details");
        Assert.assertEquals(editMarketingPeopleAdminData.getPersonEmail(), peopleDetails.getEmail(), "email doesn't match : ");
        Assert.assertEquals(editMarketingPeopleAdminData.getPersonTitle(), peopleDetails.getTitle(), "title doesn't match : ");
        Assert.assertEquals(editMarketingPeopleAdminData.getPersonPhone(), peopleDetails.getPhoneNumber(), "phone number doesn't match : ");
        Assert.assertEquals(editMarketingPeopleAdminData.getPersonAbout(), peopleDetails.getAbout(), "About doesn't match : ");
        Assert.assertEquals(UserRole.Marketing.getRole(), peopleDetails.getRoles(), "Roles doesn't match : ");

        Reporter.log("Step 5 - Again Click on edit icon and reset the people");
        peopleDetails.clickOnEditButton();
        updatePeople.fillFirstnameLastNameAndEmailDetail(mrktUser.getRealFirstName(), mrktUser.getRealLastName(),mrktUser.getEmail());
        updatePeople.clickOnSubmitButton();
        Assert.assertEquals(mrktUser.getRealFirstName() + " " + mrktUser.getRealLastName(), peopleDetails.getPeopleName(), "personName doesn't match : ");
        Assert.assertEquals(mrktUser.getEmail(), peopleDetails.getEmail(), "personEmail doesn't match : ");
    }

    /*Test 4 : Verify that marketing can view all languages and edit icon is not present*/
    @Test(priority = 4)
    public void VerifyMarketingCanViewAllLanguagesAndEditIconIsNotPresent() throws InterruptedException {
        ...
        Reporter.log("Step 1 - Navigate to url and login with marketing user");
        selenium.navigateToPage(strMarketingLanguageUrl);
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        ...
        if (!languages.isLanguagePresent(marketingLanguageAdminData.getLanguageName())) {
            headerPO.searchItemGloballyByName(marketingLanguageAdminData.getLanguageName());
        }
        languages.clickOnLanguageName(marketingLanguageAdminData.getLanguageName());
        Assert.assertEquals(languageDetailPO.getLanguageName(), marketingLanguageAdminData.getPubliicName(), "Language is not present : " + marketingLanguageAdminData.getPubliicName());
        Assert.assertFalse(languageDetailPO.isEditIconPresent(), "Language edit icon is present : ");

    }

    /*Test 5 : Verify that marketing can view all partners*/
    @Test(priority = 5)
    public void VerifyMarketingCanViewAllPartnersSuccessfully() throws InterruptedException {
        ...
        if (!partnerListing.isPartnerPresent(marketingPartnerAdminData.getPartnerName())) {
            headerPO.searchItemGloballyByName(marketingPartnerAdminData.getPartnerName());
        }
        Assert.assertTrue(partnerListing.isPartnerPresent(marketingPartnerAdminData.getPartnerName()), "Partner is not present : " + marketingPartnerAdminData.getPartnerName());
        Assert.assertFalse(partnerDetailsPO.isPartnerPointOfContactButtonEnabled(), "Point of contact id is readable : ");// todo bug(#2150)
    }

    /*Test 6 : Verify that marketing can't edit partners details */  //Todo bug(#837) Global R access
    @Test(priority = 6)
    public void VerifyThatMarketingCanNotEditAllPartnersDetails() throws InterruptedException {

        EditPartnerPO editPartnerPO = new EditPartnerPO(driver);
        PartnerDetailsPO partnerDetailsPO = new PartnerDetailsPO(driver);

        Reporter.log("Step 1 - Login with marketing user");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);

        Reporter.log("Step 2 - Verify that partner global innovations client is not edited by marketing user ");
        new PartnerFunctions(driver, selenium).editPartnerGlobalInnovationsClient(marketingPartnerAdminData.getPartnerName());
        ...
        Reporter.log("Step 3 - Verify that partner active inActive status is not edited by marketing user ");
        new PartnerFunctions(driver, selenium).editPartnerActiveInActiveStatus(marketingPartnerAdminData.getPartnerName());
        Assert.assertTrue(editPartnerPO.isActiveInActiveErrorMessagePresent(), "Partner active inActive error message is not present : ");
        editPartnerPO.clickOnCancelButton();

        Reporter.log("Step 4 - Verify that partner pmc entity code is not edited by marketing user ");
        new PartnerFunctions(driver, selenium).editPartnerPmcEntityCode(marketingPartnerAdminData.getPartnerName(), marketingEditPartnerAdminData);
        Assert.assertTrue(editPartnerPO.isPmcEntityCodeErrorMessagePresent(), "Partner pmc entity code error message is not present : ");
        editPartnerPO.clickOnCancelButton();

        Reporter.log("Step 5 - Verify that partner point of contact is not edited by marketing user ");
        new PartnerFunctions(driver, selenium).editPartnerPointOfContact(marketingPartnerAdminData.getPartnerName(), mrktUser);
        ...
        Reporter.log("Step 6 - Verify that partner types address is not edited by marketing user ");
    ...
    /*Test 7 : Verify that marketing can upload/Edit project files */
    @Test(priority = 7)
    public void VerifyThatMarketingCanUploadProjectFilesSuccessfully() throws InterruptedException {
        ...
        new FileFunctions(driver, selenium).uploadFile(marketingCreatedProjectName, textFileName);
        ...
        projectDetailsFileListingRenameFileFolderPO.clearAndRenameFileFolderName(marketingEditProjectAdminData);
        Assert.assertTrue(projectDetailsFilesHistoryListingPO.isFilePresent(marketingEditProjectAdminData.getFileName() + ".txt"), "renamed file is not present : ");
        ...
        Assert.assertFalse(projectDetailsFilesListingPO.isFileFolderPresent(marketingEditProjectAdminData.getFileName()), "deleted file is present : ");
    }

    /*Test 8 : Verify that marketing can read project budget */
    @Test(priority = 8)
    public void VerifyThatMarketingCanReadProjectBudgetSuccessfully() throws InterruptedException {
        ...
        selenium.navigateToPage(strMarketingFundingPartnershipUrl);
        selenium.hardWait(3);
        ...
        Reporter.log("Step 4 - Verify that project budget is not edited by marketing user");
    ...
    /*Test 9 : Verify that marketing can not add project team member */
    @Test(priority = 9)
    public void VerifyThatMarketingCanNotAddProjectTeamMemberSuccessfully() {

        ProjectDetailsTeamMembersListingPO projectDetailsTeamMembersListingPO = new ProjectDetailsTeamMembersListingPO(driver);

        Reporter.log("Step 1 -  Login with marketing user and and navigate on team member listing page");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        selenium.navigateToPage(strMarketingProjectTeamMemberUrl);
    ...
    /*Test 10 : Verify that marketing can not edit project team member */
    @Test(priority = 10)
    public void VerifyThatMarketingCanNotEditProjectTeamMemberSuccessfully() {

        ProjectMembersUpdateTeamMembersPO projectMembersUpdateTeamMembersPO = new ProjectMembersUpdateTeamMembersPO(driver);

        Reporter.log("Step 1 -  Login with marketing user and edit team member in created project");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        selenium.navigateToPage(strMarketingProjectTeamMemberUrl);
        ...
        Reporter.log("Step 2 - Verify that project team member is not edited by marketing user");
    ...
    /*Test 11 : Verify that marketing can not create project partnership */
    @Test(priority = 11)
    public void VerifyThatMarketingCanNotCreateProjectPartnership() throws InterruptedException {
    ...
    /*Test 12 : Verify that marketing can not edit project partnership*/
    @Test(priority = 12)
    public void VerifyThatMarketingCanNotEditProjectPartnership() throws InterruptedException {
        ...
        Reporter.log("Step 1 - Navigate to url and login with marketing user");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        selenium.navigateToPage(strMarketingPartnershipUrl);
        selenium.hardWait(3);

        Reporter.log("Step 2 - Click on partnership edit button");
        partnershipsListingPO.clickOnEditOrganizationButton();

        Reporter.log("Step 3 - Verify that project partnership is not edited by marketing user");
    ...
    /*Test 13 : Verify that marketing can not create project internship engagements*/ //todo Bug(#850)
    @Test(priority = 13)
    public void VerifyThatMarketingCanNotCreateProjectInternshipEngagements() {
        ...
        Reporter.log("Step 2 - Try to create internship engagement with marketing user");
        new InternshipEngagementsFunctions(driver, selenium).createProjectInternshipEngagements(mrktUser, marketingCreatedProjectName);
    ...
    /*Test 14 : Verify that marketing can not edit project internship engagements*/ //todo Bug(#850)
    @Test(priority = 14)
    public void VerifyThatMarketingCanNotEditProjectInternshipEngagements() throws InterruptedException {
        ...
        Reporter.log("Step 1 -  Login with marketing user and navigate in internship url");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        selenium.navigateToPage(strMarketingInternshipUrl);
    ...
    /*Test 15 : Verify that marketing can not edit project location */
    @Test(priority = 15)
    public void VerifyThatMarketingCanNotEditProjectLocation() throws InterruptedException {
        ...
        headerPO.searchItemGloballyByName(marketingLocationName);
    ...
    /*Test 16 : Verify that marketing can not create language partner project and location */
    @Test(priority = 16)
    public void VerifyThatMarketingCanNotCreateLanguagePartnerProjectAndLocation() throws InterruptedException {
    ...
    /*Test 17 : Verify that marketing can not create project language engagements */  //todo Bug(#850)
    @Test(priority = 17)
    public void VerifyThatMarketingCanNotCreateProjectLanguageEngagements() {
        ...
        Reporter.log("Step 2 - Try to create language engagement with marketing user");
        new LanguageFunctions(driver, selenium).createProjectLanguageEngagements(marketingLanguageAdminData, marketingCreatedTransEngagementProjectName,mrktUser);
    ...
    /*Test 18 : Verify that marketing can not edit language engagements details  */
    @Test(priority = 18)
    public void VerifyThatMarketingCanNotEditProjectLanguageEngagements() throws InterruptedException {
        ...
        Reporter.log("Step 1 -  Login with marketing user and navigate in language engagement url");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        selenium.navigateToPage(strMarketingLanguageTranslationUrl);
        ...
        projectDetails.clickOnViewDetailsLanguageEngagementButton(marketingLanguageAdminData.getLanguageEngagementName());
    ...
    /*Test 19 : Verify that marketing can not Add project goals */ //todo Bug(#2128)
    @Test(priority = 19)
    public void VerifyThatMarketingCanNotAddProjectGoals() throws InterruptedException {
    ...
    /*Test 20 : Verify that marketing can read created project goals */
    @Test(priority = 20)
    public void VerifyThatMarketingCanReadProjectGoals() throws InterruptedException {
        ...
        Reporter.log("Step 1 - Navigate to url and login with marketing user");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);
        selenium.navigateToPage(strMarketingProjectCreateGoalUrl);
        selenium.hardWait(3);
        ...
        Reporter.log("Step 4 - Verify that marketing can read created project goals");
    ...
    /*Test 21 : Verify that marketing can not edit projects */
    @Test(priority = 21)
    public void VerifyThatMarketingCanNotEditProjectsSuccessfully() throws InterruptedException {
        ...
        Reporter.log("Step 1 -  Login with marketing user and edit created project");
        new LoginFunctions(driver, selenium).loginByGivenUser(mrktUser);

        Reporter.log("Step 2 - Verify that project is displayed which is edited by marketing user ");
        sideHeader.clickOnProjectsMenu();
        projectsListingPO.clickOnProjectSubTabs(ProjectSubTabs.All.getProjectSubTabs());
        ...
        Reporter.log("Step 4 - Verify that marketing can't edit field region");
        ...
        Reporter.log("Step 7 - Verify that marketing can't edit start end date");
        ...
        Reporter.log("Step 9 - Click on project estimated submission date button and try to edit with marketing user ");
        projectDetails.clickProjectEstimatedSubmissionButton();

        Reporter.log("Step 10 - Verify that marketing can't edit estimated submission date");
        ...
        Reporter.log("Step 12 - Click on project status button and try to edit with marketing user ");
        projectDetails.clickOnProjectStepByName(ProjectStep.EarlyConversations.getStep());

        Reporter.log("Step 13 - Verify that marketing can't edit status");
